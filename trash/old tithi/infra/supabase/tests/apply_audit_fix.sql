-- =================================================================
-- Apply Audit Function Fix
-- Run this FIRST before any validation scripts that might trigger audit
-- =================================================================

-- Replace the audit function to handle tables without id column
...
SELECT '✅ Audit function updated to handle tables without id column' as status;
