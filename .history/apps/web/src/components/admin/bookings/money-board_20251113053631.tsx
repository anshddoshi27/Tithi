...
function MoneyCard({
  ...
  return (
    <article className="rounded-3xl border border-white/10 bg-gradient-to-br from-white/10 via-white/5 to-transparent p-6 shadow-[0_40px_120px_rgba(6,20,70,0.35)] transition hover:border-primary/40 hover:shadow-[0_50px_140px_rgba(34,102,255,0.35)]">
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[2fr,1fr]">
        ...
        <div className="rounded-2xl border border-white/15 bg-white/5 p-5">
          ...
          <Button
            type="button"
            variant="ghost"
            className="mt-4 w-full justify-center text-white"
            onClick={onInspect}
          >
            View full booking
          </Button>
...
function BookingDetailDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur">
      <div className="relative max-h-[90vh] w-full max-w-4xl overflow-y-auto rounded-3xl border border-white/10 bg-[#060F28] px-8 py-10 shadow-[0_60px_160px_rgba(4,12,35,0.55)]">
        <button
          type="button"
