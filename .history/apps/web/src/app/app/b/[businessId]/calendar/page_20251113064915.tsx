  ...
  return (
    <article className="rounded-3xl border border-white/10 bg-white/5 p-6">
      <header className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <p className="text-xs uppercase tracking-wide text-white/50">Staff member</p>
          ...
          <p className="text-xs text-white/50">{staff.role ?? "Scheduling only"}</p>
        </div>
        <div className="rounded-full border border-white/15 bg-white/5 px-3 py-1 text-xs text-white/60">
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {sortedSlots.length ? (
          ...
          <div className="rounded-2xl border border-dashed border-white/15 bg-white/[0.02] px-4 py-8 text-center text-sm text-white/50">
            No slots yet — add a day/time block below.
          </div>
        )}
      </div>

      <form onSubmit={handleSubmit} className="mt-6 grid gap-4 rounded-2xl border border-white/10 bg-white/5 p-5 sm:grid-cols-4">
        <div className="sm:col-span-1">
          <Label className="text-xs uppercase tracking-wide text-white/50">Day</Label>
          <select
