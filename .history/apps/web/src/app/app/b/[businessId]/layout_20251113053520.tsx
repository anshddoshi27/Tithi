...
export default function AdminBusinessLayout({
  ...
  if (!business || !workspace) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-[#050F2C] via-[#071433] to-[#0B1D45]">
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-[#050F2C] via-[#071433] to-[#0B1D45] text-white">
      <aside className="hidden min-w-[260px] border-r border-white/10 bg-white/5/60 backdrop-blur-xl lg:flex lg:flex-col">
                  ...
                  >
                    <span
                      className={`flex h-8 w-8 items-center justify-center rounded-xl border ${
                        isActive ? "border-primary/40 bg-primary/15 text-white" : "border-white/10 bg-white/5 text-white/60 group-hover:text-white"
                      }`}
                    >
                      {item.icon}
                    </span>
      ...
      <div className="flex flex-1 flex-col">
        <header className="sticky top-0 z-20 border-b border-white/10 bg-[#050F2C]/70 backdrop-blur-xl">
          <div className="flex items-center justify-between px-4 py-4 sm:px-8">
            <div className="flex items-center gap-4">
              ...
              <Button
                ...
                className="hidden items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-2 text-sm font-semibold text-white/80 transition hover:border-white/25 hover:text-white lg:inline-flex"
              >
                Open booking page
              </Button>
            </div>
            <div className="flex items-center gap-3">
              <div className="hidden items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3 py-1 text-xs text-white/60 sm:flex">
                <span
