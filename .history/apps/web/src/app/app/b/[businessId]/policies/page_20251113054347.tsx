    ...
    <div className="space-y-10">
      ...
      <form onSubmit={handleSubmit} className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-3xl border border-white/15 bg-white/5 p-6">
          <h2 className="text-lg font-semibold text-white">Cancellation fee</h2>
        ...
        <div className="rounded-3xl border border-white/15 bg-white/5 p-6">
          <h2 className="text-lg font-semibold text-white">No-show fee</h2>
          <p className="mt-1 text-xs uppercase tracking-wide text-white/40">
        ...
        <div className="lg:col-span-2 flex items-center justify-between rounded-3xl border border-white/15 bg-white/5 px-6 py-4">
          <div>
            {error ? (
      ...
      <section className="rounded-3xl border border-white/15 bg-white/5 p-6 text-sm text-white/70">
        <h2 className="text-lg font-semibold text-white">Checkout preview</h2>
        <div className="mt-4 max-h-72 space-y-4 overflow-y-auto rounded-2xl border border-white/10 bg-white/5 p-5">
...
function PolicyEditor({
  ...
  return (
    <div className="rounded-3xl border border-white/15 bg-white/5 p-6">
      ...
      <p className="mt-1 text-xs uppercase tracking-wide text-white/40">{description}</p>
      <Textarea
        rows={8}
        className="mt-4"
        value={value}
