...
export const DEV_WORKSPACE_SEED: WorkspaceSeedInput = {
  business: {
      ...
      services: [
        {
          ...
          staffIds: ["staff_ava", "staff_jalen"]
        },
        {
          id: "svc_blend",
          name: "Color Blend",
  ...
  availability: [
    {
      ...
      staff: [
        {
          staffId: "staff_ava",
          slots: generateWeeklySlots(["monday", "wednesday", "friday"], "09:00", "17:00")
        },
        {
          staffId: "staff_jalen",
          slots: generateWeeklySlots(["tuesday", "thursday"], "10:00", "18:00")
        }
      ]
    },
    {
      ...
      staff: [
        {
          staffId: "staff_ava",
          slots: generateWeeklySlots(["tuesday", "thursday"], "11:00", "16:00")
        }
      ]
    },
    {
      ...
      staff: [
        {
          staffId: "staff_jalen",
          slots: generateWeeklySlots(["monday", "wednesday", "saturday"], "10:00", "16:00")
        }
      ]
    }
  ],
  notifications: [
    {
      ...
      body:
        ...
        "We’ll only charge your card after the appointment per ${business.name} policies.",
      enabled: true
    },
    {
      id: "reminder-24h",
      ...
      body:
        "Reminder: ${service.name} tomorrow at ${booking.time}. Need to change plans? Call us at +1 917 555 0100.",
      enabled: true
    },
    {
      ...
      body:
        "Hi ${customer.name}, thanks for visiting. We captured ${service.price} after your appointment. " +
        "View policies and next steps here: ${booking.url}",
      enabled: true
    }
  ],
  policies: {
  ...
  giftCards: {
    ...
    expirationMonths: 12,
    generatedCodes: ["WELCOME120", "SELFCARE20"]
  },
  payment: {
